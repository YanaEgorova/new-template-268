...
export const WEBSITE_RETURN_ADDRESS =
  '1025 Industry Rd Harrodsburg, KY 40330, USA';
export const WEBSITE_DESCRIPTOR = '8449263651piecesofchar';
export const WEBSITE_FULFILLMENT = 'Fulfill Brokerage Inc.';

const templateNumber = 'new-template-268';
...
let websiteReturnAddress = document.querySelectorAll(
  '.js_website-return-address'
);
...
const SECONDARY_TAGLINE =
  'We offer a wide range of products to help you achieve your health goals.';
if (mainPageTitle) {
